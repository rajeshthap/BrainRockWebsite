...
const HrDashBoard = () => {
  ...
  const statsData = [
    ...
    },
    {
     ...
     {
      title: "Attentance Daily/Monthly",
      value: "5",
      change: "+2.1%",
      icon: <FaTachometerAlt />,
    },
     {
      title: "Leave/Attandance alert",
      value: "5",
      change: "+2.1%",
      icon: <FaTachometerAlt />,
    },
    ...
    <Card.Body style={{ height: 300 }}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="present" stroke="#0d6efd" name="Present" strokeWidth={2} dot={{ r: 4 }} />
          <Line type="monotone" dataKey="absent" stroke="#dc3545" name="Absent" strokeWidth={2} dot={{ r: 4 }} />
        </LineChart>
      </ResponsiveContainer>
    </Card.Body>
  </Card>
  ...
  <Card className="shadow-sm">
    ...
    <Table hover responsive>
      ...
      <tbody>
        {[
          { name: "Amit Sharma", dept: "HR", role: "Manager", joined: "Nov 1" },
          { name: "Sneha Patel", dept: "Tech", role: "Developer", joined: "Nov 3" },
          { name: "Raj Mehta", dept: "Sales", role: "Executive", joined: "Nov 5" },
        ].map((j, i) => (
          <tr key={i}>
            <td>{j.name}</td>
            <td>{j.dept}</td>
            ...
            {/* Leave Announcements */}
             ...
             <Row>
              <Col lg={12} md={12} sm={12}><Card className="quick-actions-card">
                <Card.Header>
