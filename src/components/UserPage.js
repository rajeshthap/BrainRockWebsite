            ...
            <Col lg={6} md={6} sm={12}>
              <div className=" d-flex flex-column h-100 align-items-start justify-content-center bottom-0 resorce-sub-title ">
                <h1 className=" bg-opacity-50 py-2 px-4">
                 <span className="br-span-title"> Empowering</span> <span className="br-span-sublist">Your Business</span> <span className="br-span-title">With</span>
                  <br></br> <span className="br-span-list">Next-Gen IT</span> <span className="br-span-sublist">Solutions</span>
                </h1>
        ...
        <Row className="mt-3">
          ...
          <Col lg={6} md={6} sm={12}>
            <div className="br-img">
              <i>
                <img src={PoorImg} alt="groupimage" className="img-fluid br-img"></img>
              </i>
            </div>
          </Col>
        </Row>
      ...
      <Container>
        <div className="resorce-sub-list-design">
          <h1 className="text-center">
            Our design and <br></br><span className="br-span-list mt-3" >development approach</span>
          </h1>
          <Row className="mt-4">
            <Col lg={6} md={6} sm={12} className="mb-3">
              <Card className="p-3 card-box-details">
                <Row>
                  <Col lg={2} md={2} sm={12}>
                    <div className="">
              ...
              <Card className="p-3 card-box-details">
                <Row>
                  ...
                  <Col lg={10} md={10} sm={12} className="services-design-head">
                    ...
                    <p>
                     We bridge the gap between teams and stakeholders to create a clear, common vision. By fostering collaboration and aligning goals, we ensure seamless communication and successful project outcomes.
                    </p>
                  </Col>
                </Row>
              </Card>
